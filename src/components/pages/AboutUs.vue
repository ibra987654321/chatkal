<template>
  <h2 class="text-4xl my-5 font-bold text-center tracking-tight text-gray-900">О нас</h2>
  <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 via-green-100 to-white">
    <div class="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
      <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
        <div class="sm:max-w-lg">
          <h1 class="font text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Почему с нами выгодно работать?</h1>
          <p class="backdrop:blur-sm bg-white/30 p-2 mt-4 text-xl text-gray-500">This year, our new summer collection will shelter you from the harsh elements of a world that doesn't care if you live or die.</p>
